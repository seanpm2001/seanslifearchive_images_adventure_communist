...
----
Installing SeansLifeArchive/Images/AdCom
----

SeansLifeArchive/Images/AdCom currently doesn't require installation, it is just a collection of images and data. It is part of the Seanpm2001 Life Archive project, and for proper "installation" the repository should be placed under /SeansLifeArchive/<yourInstalledVersion>/Resources/Images/
...
----
Install instructions file version: 2 (2022, Wednesday, May 11th at 6:47 pm PST)
----
